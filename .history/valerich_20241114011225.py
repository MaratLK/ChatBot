...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    [InlineKeyboardButton("Команда о Конст Вал (видео)", callback_data='option2')],
    [InlineKeyboardButton("Пожелания Константину (видео)", callback_data='option3')],
    [InlineKeyboardButton("Зарядиться энергией команды (видео)", callback_data='option4')],
    [InlineKeyboardButton("Тест (самооценка) 360", callback_data='option5')]
]
